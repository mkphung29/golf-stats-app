package com.golfstats.statssystem.entity;
...
public class CourseEntity {
    ...
    public CourseEntity(long id, String courseName, String date, float userScore, int yardage, int par, float courseRating, float courseSlope, float courseHandicap, int fairways, int gir, int ud, int putts) {
        this.id = id;
