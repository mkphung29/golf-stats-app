...
const EditCourse = ({ courseId, setResponseCourse }) => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try{
            const response = await fetch(COURSE_BASE_URL + "/" + courseId, {
                method: "GET",
                headers: {
                    ...
                    <div className="flex max-w-md max-auto">
                        <div className="py-2">
                            ...
                            <div className="h-14 my-4 space-x-4 pt-4">
                                <button onClick={updateCourse} className="rounded text-white font-semibold bg-green-400 hover:bg-green-700 py-2 px-6">Update</button>
